...
setupEventListeners() {
    ...
    document.addEventListener('click', (e) => {
        ...
        // Modal triggers - use direct method calls
    ...
    // Add modal close listeners to the document
    document.addEventListener('click', (e) => {
...
openModal(modalType) {
    ...
    if (!document.getElementById(`${modalType}-modal`)) {
        ...
        // Re-attach event listeners for the new modal
        this.attachModalEventListeners(modalType);
    }
...
// Add this new method to attach modal event listeners
attachModalEventListeners(modalType) {
    ...
    if (form) {
        form.addEventListener('submit', (e) => {
            e.preventDefault();
            this.handleModalSubmit(modalType, e);
        });
    }
    
    // Rating stars for feedback modal
    if (modalType === 'feedback') {
    ...
    // Progress slider for project modal
    if (modalType === 'project') {
        const progressSlider = modal.querySelector('#project-progress');
        if (progressSlider) {
...
// Update the handleModalSubmit method
handleModalSubmit(modalType, e) {
    switch (modalType) {
        case 'client':
